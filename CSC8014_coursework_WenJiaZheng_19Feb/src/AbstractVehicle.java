...
/**
 * Abstract base class for all vehicles in the Vehicle Hire Management System.
 * Provides common functionality for vehicle ID, mileage tracking, hire status, and service handling.
 */
public abstract class AbstractVehicle implements Vehicle {
    ...
    /**
     * Checks if service is due based on distance and performs it if so.
    ...
    /**
     * Returns the hash code for this vehicle based on its ID.
     *
