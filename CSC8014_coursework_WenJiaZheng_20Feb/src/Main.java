/**
 * Test driver for the Vehicle Hire Management System.
 * Runs boundary tests, exception handling tests, and ID generation validation.
 */
...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            System.out.println("Starting Running full system boundary tests...\n");
            ...
            System.out.println("\nTest failed. An error was detected: ");
            t.printStackTrace();
        }
    }
    ...
    public static void testVehicleManager() {
        ...
        // Set up a standard adult customer (Christy, 1991)
        ...
        System.out.println("All basic and exception tests: PASSED");
    }
    ...
    public static void testAgeBoundaries() {
        ...
        System.out.println("Age boundary tests (exactly 18 and 23 years): PASSED");
    }
    ...
    /**
     * Verifies that vehicle mileage is reset after service threshold is reached.
     * Tests both Car (10,000 miles) and Van (5,000 miles) requirements.
     */
    public static void testServiceMileageBoundary() {
        ...
        Calendar cal = Calendar.getInstance();
        cal.set(1991, Calendar.JANUARY, 1);
        // Set commercial license to true to allow van hire
        CustomerRecord tester = vm.addCustomerRecord("Service", "Tester", cal.getTime(), true);

        // --- Test 1: Car (10,000 mile threshold) ---
        vm.hireVehicle(tester, "car", 1);
        vm.returnVehicle(car.getVehicleID(), tester, 10000);
        // Ensure mileage is reset to 0 for car
        Assertions.assertEquals(0, car.getCurrentMileage());

        // --- Test 2: Van (5,000 mile threshold) ---
        vm.hireVehicle(tester, "van", 1);
        vm.returnVehicle(van.getVehicleID(), tester, 5000);
        // Ensure mileage is reset to 0 for van
        Assertions.assertEquals(0, van.getCurrentMileage());

        System.out.println("Service Mileage Boundary tests (Car 10000 / Van 5000 reset): PASSED");
    }
